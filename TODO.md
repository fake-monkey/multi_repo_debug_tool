...
本文件记录 `repo_debug` 的待办事项。已完成历史见 [CHANGELOG.md](CHANGELOG.md) 与 [设计文档.md](设计文档.md) 的 TODO List。
...
完整的产品定位、项目布局、数据关系、前端 / Tauri 壳布局、依赖方向与第一阶段验收标准均已在 [桌面端项目计划.md](桌面端项目计划.md) 中写明，此处只做索引，不重复。
